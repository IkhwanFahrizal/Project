...
<body>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                while ($kategori = mysqli_fetch_array($listkategori)) {
                    ...
                    ?>
                    <div id="kategori-<?php echo $kategori_id; ?>" class="text-center wow fadeInUp" data-wow-delay="0.1s">
    ...
    <script>
    // JavaScript untuk menambahkan smooth scrolling behavior pada setiap kategori
    var smoothScrollLinks = document.querySelectorAll('.section-title a');
